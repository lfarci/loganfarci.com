...
- [Agentic workflow team](docs/agentic-workflows.md) — the autonomous agents and native auto-merge flow that take an issue to a merged PR with spec-based checks.
