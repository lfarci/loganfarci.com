...
| TASK-007 | Extend `src/src/components/shared/MarkdownContent.test.tsx` to verify that exactly one table-of-contents link exposes `aria-current="location"` initially and that the current link includes both the font-weight and left-indicator classes. Depends on TASK-005 and TASK-006.                                                                                                                                                                                                                                                                                                            | ✅        | 2026-07-30 |
