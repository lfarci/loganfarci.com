...
Use `python scripts/build-resume.py --output build/resume` to generate and validate the PDF. The generated output is intentionally outside this directory and must not be committed.
