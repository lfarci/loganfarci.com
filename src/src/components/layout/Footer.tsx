...
const Footer: React.FC<FooterProps> = ({ githubRepositoryUrl, commitHash, commitHashLength = 7 }) => {
    ...
    return <footer className="max-w-screen-lg mx-auto px-4 flex flex-wrap justify-between items-center pb-8 gap-y-2">
        ...
        {showCommitHash && <div className="flex flex-wrap items-center gap-1 min-w-0">
