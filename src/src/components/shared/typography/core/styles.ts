export const typographyStyles = {
    ...
    secondary: "text-sm leading-6 md:text-base md:leading-7 text-text-tertiary text-font",
    strong: "font-semibold text-text-secondary text-font",
    ...
    unorderedList:
        "list-disc list-outside pl-6 mb-5 space-y-2 text-base leading-7 md:text-[1.0625rem] md:leading-8 text-text-secondary text-font",
    orderedList:
        "list-decimal list-outside pl-6 mb-5 space-y-2 text-base leading-7 md:text-[1.0625rem] md:leading-8 text-text-secondary text-font",
